...
const OXYLABS_USERNAME="{your username}"
const OXYLABS_PASSWORD="{your password}"

export async function fetchResults(searchParams: SearchParams) {
    const username = OXYLABS_USERNAME
    const password = OXYLABS_PASSWORD
                ...
                _items: {
                    ...
                    description: {
                        _fns : [
                            {
                                _fn: "xpath_one",
                                _args: [".//h4[contains(@class, 'abf093bdfee8f7c0707a7')]/text()"],
                            },
                        ],
                    },
                    booking_metadata: {
                        _fns : [
                            {
                                _fn: "xpath_one",
                                _args: [".//div[contains(@class, 'c5ca594cb1 f19ed67e4b')]/div[contains(@class, 'abf093bdfef45d8e4c32')]/text()"],
                            },
                        ],
                    },
                    link: {
